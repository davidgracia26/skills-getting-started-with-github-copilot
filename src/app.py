...
activities = {
    ...
    "Art Studio": {
        ...
        "max_participants": 14,
        "participants": ["sara@mergington.edu", "lena@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, improv, and prepare school theater productions",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "oliver@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments, science fairs, and STEM challenges",
